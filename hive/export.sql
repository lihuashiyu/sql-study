...
(
	dt                     date   not null comment '统计日期',
	recent_days            bigint not null comment '最近天数：1，最近 1 日；7，最近 7 日；30，最近 30 日',
...
(
	dt                date           not null comment '统计日期',
	recent_days       bigint         not null comment '最近天数,7:最近7天,30:最近30天',
...
(
	dt                date   not null comment '统计日期',
	recent_days       bigint not null comment '最近 N 日：1，最近 1 日；7，最近 7 日；30，最近 30 日',
